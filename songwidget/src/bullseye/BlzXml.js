...
//  constructor
Blz.XML.SimpleElement = Class.create();
Blz.XML.SimpleElement.prototype = {
  ...
  scalar2xml: function(name, text) {
    if (name == "#text") return this.escape(text);
    else return "<"+name+">"+this.escape(text)+"</"+name+">\n";
  },
